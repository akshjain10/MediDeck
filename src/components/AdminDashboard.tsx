...
import {
    LogOut, Package, Eye, EyeOff, Building, BarChart3, PlusCircle, Settings, Users
} from 'lucide-react';
import {
  Dialog,
  DialogContent,
...
const AdminDashboardTAB = () => {
    ...
    const visibleCount = localProducts.filter(p => p.visibility).length;
    const hiddenCount = localProducts.length - visibleCount;
    const companyCount = new Set(localProducts.map(p => p.Company)).size;
